...
async function main() {
  console.log("Seeding Z Shop database...");
  ...
  // Seed a few sample reviews for top-rated products
  const sampleReviews = [
    {
      productSlug: "aurora-noise-cancelling-headphones",
      reviews: [
    ...
    {
      productSlug: "nimbus-ultrabook-14",
      reviews: [
    ...
    {
      productSlug: "crispair-air-fryer",
      reviews: [
